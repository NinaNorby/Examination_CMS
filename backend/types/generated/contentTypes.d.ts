...
export interface ApiBookBook extends Schema.CollectionType {
  ...
  attributes: {
    ...
    realeseDate: Attribute.Date;
    bookImage: Attribute.Media & Attribute.Required;
...
export interface ApiReadlistReadlist extends Schema.CollectionType {
  ...
  attributes: {
    ...
    BookID: Attribute.Integer & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiThemeTheme extends Schema.SingleType {
  ...
  attributes: {
    theme: Attribute.Enumeration<['Light', 'Blue', 'Green']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::theme.theme',
